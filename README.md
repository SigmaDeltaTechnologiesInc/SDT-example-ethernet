...
```
mbed import https://github.com/SigmaDeltaTechnologiesInc/SDT-example-ethernet
cd SDT-example-ethernet
```
...
Image: .\BUILD\SDT64B\GCC_ARM\SDT-example-ethernet.bin
```

### 1-4. Program your board

1. Connect your mbed device to the computer over USB.
1. Copy the binary file(SDT-example-ethernet.bin) to the mbed device.
